    		...
    		<ul className="row m-0 p-0">
	    		<li className="list-portfolio col-12 text-left d-flex">
	    			<div className="block-img">	
	    				<img src="https://hltec.com.br/img/viagenslovers.jpg" />
	    			</div>
	    		...
	    		<li className="list-portfolio col-12 text-left d-flex">
	    			<div className="block-img">	
	    				<img src="https://hltec.com.br/img/playerlink.jpg" />
	    			</div>
	    			<div class="block-title">
	    		...
	    		<li className="list-portfolio col-12 text-left d-flex">
	    			<div className="block-img">	
	    				<img src="https://hltec.com.br/img/letrasaqui.jpg" />
	    			</div>
	    			<div class="block-title">
	    		...
	    		<li className="list-portfolio col-12 text-left d-flex">
	    			<div className="block-img">	
	    				<img src="https://hltec.com.br/img/agenciadeideias.jpg" />
	    			</div>
	    			<div class="block-title">
